...
export function DashboardView() {
  const { data: hoursThisMonth, isLoading } = useQuery(
    ["hours"],
  ...
  const grouped =
    updatedHoursThisMonth &&
    updatedHoursThisMonth.reduce(
      (
        acc: {
          [x: string]: {
            clientName: string;
        ...
        acc[clientId].projects[projectId].activities[
          activityTitle
